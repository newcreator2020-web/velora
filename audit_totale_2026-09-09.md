...
- Routes:
  ...
  - Dynamic (36): tutte /api/_, /app/_, /s/[slug]/*, /booking, /dashboard, /login, /onboarding ecc.
...
**Force RLS (relforcerowsecurity=t) FORTE:** 24/29 tabelle ✅ (audit_logs, bookings, business__, customers, interaction_events, media__, platform_admins, platform_provisioning_requests, profiles, prospect__, resource__, services, site__, staff__, tenant_memberships, tenants).
